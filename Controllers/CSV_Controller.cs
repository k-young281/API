...
namespace WebApplication2.Controllers
{
    ...
    public class CSV_Controller : ApiController
    {
        ...
        public HttpResponseMessage  Get()
        {
            ...
            DataTable dt = data.GetResourceCSV();
            ...
            message.Content = new StringContent(sBuilder.ToString());
            message.Content.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/octet-stream");
            message.Content.Headers.ContentDisposition = new System.Net.Http.Headers.ContentDispositionHeaderValue("attachement");
    ...
    public class CSVData
    {
        ...
        public DataTable GetResourceCSV()
        {
